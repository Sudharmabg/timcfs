        ...
        <footer className="site-footer">
            <div className="footer-main">
                ...
                <div className="footer-social">
                    <a href="https://www.instagram.com/mcfs.technoindia/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="footer-social-link">
                    ...
                    <a href="https://www.facebook.com/p/Techno-India-Group-Manchester-City-Football-School-61565804545240/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer-social-link">
                    ...
                    <a href="https://www.youtube.com/@TIMCFS" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="footer-social-link">
